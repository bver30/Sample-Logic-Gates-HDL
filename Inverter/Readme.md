...
This is how your waveform should look like. Since this is a sample for inverter, the output should be opposite to the input. The picture below shows a correct behavior of the inverter in which the `a` is set as the input while `b` is the output
